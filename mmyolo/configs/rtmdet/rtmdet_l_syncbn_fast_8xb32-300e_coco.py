...
train_batch_size_per_gpu = 1#32
# Worker to pre-fetch data for each single GPU during training
train_num_workers = 1#10
...
val_batch_size_per_gpu = 1# 32
# Worker to pre-fetch data for each single GPU during validation
val_num_workers =1#10
...
model = dict(
    ...
    #backbone=dict(
       # type='mmdet.FasterNet',
       # style='pytorch',
	#fork_feat=True,
        #init_cfg=dict(
        #    type='Pretrained',
        #    checkpoint='../ckpts/mymodel_t0.pth',
        #    prefix='backbone.',
       #     ),
     #  init_cfg=None,
    #),
